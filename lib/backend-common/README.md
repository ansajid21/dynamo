...
> [Writing Unified Backends](../../docs/fern/developer-guide/advanced-customizations/writing-custom-backends/writing-unified-backends.md)
...
See the [walkthrough](../../docs/fern/developer-guide/advanced-customizations/writing-custom-backends/writing-unified-backends.md) and choose
...
[walkthrough](../../docs/fern/developer-guide/advanced-customizations/writing-custom-backends/writing-unified-backends.md) for the
...
[guide's Rust Step 6](../../docs/fern/developer-guide/advanced-customizations/writing-custom-backends/writing-unified-backends.md) for the
`invalid_arg` pattern.
