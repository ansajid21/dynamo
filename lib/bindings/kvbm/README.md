...
![A block diagram showing a layered architecture view of Dynamo KV Block manager.](../../../docs/fern/assets/img/kvbm-components.svg)
...
See the [support matrix](../../../docs/fern/reference/general/compatibility.mdx) for version compatibility questions.
...
For more detailed integration with dynamo, disaggregated serving support and benchmarking, please check [vllm-setup](../../../docs/fern/developer-guide/knowledge-base/modular-components/kvbm/kvbm-guide.md#run-kvbm-in-dynamo-with-vllm)
...
For more detailed integration with dynamo and benchmarking, please check [trtllm-setup](../../../docs/fern/developer-guide/knowledge-base/modular-components/kvbm/kvbm-guide.md#run-kvbm-in-dynamo-with-tensorrt-llm)


## 📚 Docs

- [Architecture](../../../docs/fern/developer-guide/knowledge-base/modular-components/kvbm/overview.md#architecture)
- [Design Deepdive](../../../docs/fern/developer-guide/knowledge-base/modular-components/kvbm/kvbm-design.md)
