...
> If not, follow the **[Kubernetes Deployment Guide](../docs/fern/kubernetes/getting-started/quickstart.mdx)** first.
...
- **[Kubernetes Deployment Guide](../docs/fern/kubernetes/getting-started/quickstart.mdx)** - Quickstart (~10 minutes)
- **[Detailed Installation Guide](../docs/fern/kubernetes/installation/install-dynamo.md)** - Advanced options
...
- [Dynamo Operator](../docs/fern/developer-guide/knowledge-base/kubernetes/kubernetes-operator/dynamo-operator.md)
- [Observability Documentation](../docs/fern/kubernetes/operations/observability.mdx)

## Related Documentation

- **[Kubernetes Deployment Guide](../docs/fern/kubernetes/getting-started/quickstart.mdx)** - Platform installation and concepts
- **[API Reference](../docs/fern/reference/kubernetes-api/additional-resources/api-reference-k8s.md)** - DynamoGraphDeployment CRD specification
- **[vLLM Backend Guide](../docs/fern/developer-guide/knowledge-base/modular-components/backends/vllm/overview.md)** - vLLM-specific features
- **[SGLang Backend Guide](../docs/fern/developer-guide/knowledge-base/modular-components/backends/sglang/overview.md)** - SGLang-specific features
- **[TensorRT-LLM Backend Guide](../docs/fern/developer-guide/knowledge-base/modular-components/backends/tensorrt-llm/overview.md)** - TensorRT-LLM features
- **[Observability](../docs/fern/kubernetes/operations/observability.mdx)** - Monitoring and logging
- **[Benchmarking Guide](../docs/fern/recipes/feature-benchmarks/benchmarking-guide.md)** - Performance testing
