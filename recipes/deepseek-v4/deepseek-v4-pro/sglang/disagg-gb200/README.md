...
See [Disagg Communication Guide](../../../../../docs/fern/developer-guide/knowledge-base/kubernetes/kubernetes-operator/disagg-communication.md#aws-efa-configuration) for EFA-specific NIXL configuration with libfabric.
