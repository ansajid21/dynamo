...
1. **Dynamo Platform installed** - See [Kubernetes Deployment Guide](../../docs/fern/kubernetes/getting-started/quickstart.mdx)
2. **GB200**
...
**2. Agg embedding cache uses vLLM's native `ec_both` ECConnector role, supported in vLLM 0.17+. No patches required. See [multimodal-vllm.md](../../docs/fern/developer-guide/knowledge-base/modular-components/backends/vllm/multimodal.md#embedding-cache) for more details.**
