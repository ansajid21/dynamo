...
<Steps>
  ...
  <Step title="Install for your backend">
    ...
    See [Release Artifacts](../../reference/general/release-artifacts.mdx#container-images) for the complete artifact inventory.
...
- [Disaggregated Serving](../../kubernetes/model-deployment/disaggregated-serving.md) -- Scale prefill and decode independently
