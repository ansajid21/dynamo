...
对于生产环境的多节点集群，请参阅 [Kubernetes 部署指南](../../../../../pages/kubernetes/getting-started/quickstart.mdx)。如需为开发从源码构建，请参阅[从源码构建](../../developer-guide/advanced-customizations/building-from-source.md)。
...
如需查看包含后端框架版本在内的完整兼容性矩阵，请参阅[支持矩阵](../../../../../pages/reference/general/compatibility.mdx)。
...
如需查看可用版本，请参阅[发布产物](../../../../../pages/reference/general/release-artifacts.mdx)；
如需运行说明，请参阅各后端指南：[SGLang](../../../../../pages/developer-guide/knowledge-base/modular-components/backends/sglang/overview.md) |
[TensorRT-LLM](../../../../../pages/developer-guide/knowledge-base/modular-components/backends/tensorrt-llm/overview.md) | [vLLM](../../../../../pages/developer-guide/knowledge-base/modular-components/backends/vllm/overview.md)
...
本指南使用 `--discovery-backend file`。如需设置 etcd，请参阅[服务发现](../../../../../pages/developer-guide/knowledge-base/kubernetes/kubernetes-operator/service-discovery.md)。
...
请参阅 [Kubernetes 中的模型缓存](../../../../../pages/kubernetes/model-deployment/model-loading/model-caching.mdx#option-2-modelexpress-p2p-distribution)
    了解正确配置。
...
运行 `nvidia-smi` 检查你的驱动版本。Dynamo 对 CUDA 12 需要驱动 575.51.03+，对 CUDA 13 需要驱动 580.00.03+。B300/GB300 GPU 需要 CUDA 13。完整要求请参阅[支持矩阵](../../../../../pages/reference/general/compatibility.mdx)。
...
- [后端指南](../../../../../pages/developer-guide/knowledge-base/modular-components/backends/sglang/overview.md) -- 后端特定配置和功能
- [分离式服务](../../../../../pages/kubernetes/model-deployment/disaggregated-serving.md) -- 独立扩展 prefill 和 decode
- [KV Cache 感知路由](../../../../../pages/developer-guide/knowledge-base/modular-components/router/router-guide.md) -- 智能请求路由
- [Kubernetes 部署](../../../../../pages/kubernetes/getting-started/quickstart.mdx) -- 生产环境多节点部署
