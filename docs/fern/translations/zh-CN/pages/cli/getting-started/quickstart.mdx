...
<CardGroup cols={4}>
  <Card title="快速开始" icon="regular bolt" href="quickstart.mdx">
    你在这里。容器快速路径。
  </Card>
  <Card title="本地安装" icon="regular laptop-code" href="../installation/install-dynamo.mdx">
    完整演练 — PyPI、配置。
  </Card>
  <Card title="Kubernetes" icon="regular cubes" href="../../../../../kubernetes/model-deployment/overview.mdx">
    生产级多节点集群。
  </Card>
  <Card title="从源码构建" icon="regular code-branch" href="../../developer-guide/advanced-customizations/building-from-source.md">
    面向基于 `main` 的贡献者。
  </Card>
</CardGroup>
...
有关容器版本和标签，请参阅 [Release Artifacts](../../../../../reference/general/release-artifacts.mdx)。
...
<Info>
连接被拒绝？前端需要几秒钟才能启动 — 请重试。有关生产环境的存活和就绪探针，请参阅 [Health Checks](../../../../../reference/observability/health-checks.mdx)。
</Info>

## 摘自 Digest

<CardGroup cols={2}>
  <Card title="面向 Agentic Inference 的全栈优化" icon="regular microchip" href="../../../../../blog/2026/agentic-inference-optimizations.mdx">
    Dynamo 如何在三层上优化 agentic 工作负载：前端 API、路由器和 KV cache 管理。
  </Card>
  <Card title="Flash Indexer：跨星系 KV 路由" icon="regular bolt" href="../../../../../blog/2026/flash-indexer.mdx">
...
<CardGroup cols={2}>
  <Card title="架构" icon="regular sitemap" href="../../developer-guide/knowledge-base/overview.md">
    前端、路由器和 worker 如何协同工作。
  </Card>
  <Card title="前端指南" icon="regular bolt" href="../../../../../developer-guide/knowledge-base/modular-components/frontend/overview.md">
    Worker 发现、多模型路由、OpenAI 兼容性。
  </Card>
  <Card title="KV Cache 感知路由" icon="regular route" href="../../../../../developer-guide/knowledge-base/modular-components/router/routing-concepts.md#kv-cache-routing">
    路由器如何为了前缀复用而放置请求。
  </Card>
  <Card title="Health Checks" icon="regular heart-pulse" href="../../../../../reference/observability/health-checks.mdx">
    生产部署的存活和就绪探针。
  </Card>
</CardGroup>
