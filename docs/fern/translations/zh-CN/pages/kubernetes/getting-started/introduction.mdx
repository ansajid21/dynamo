...
| 内存管理 | Dynamo KV Block Manager、[LMCache](../../../../../pages/cli/model-deployment/kv-cache-offloading.mdx)、[SGLang HiCache](../../../../../pages/developer-guide/knowledge-base/modular-components/backends/sglang/hicache.md)、[FlexKV](../../../../../pages/cli/model-deployment/kv-cache-offloading.mdx) |
| 网络和存储 | Mooncake、DOCA NetIO、GDS、POSIX、S3、3FS（[通过 NIXL 支持](../../../../../pages/developer-guide/knowledge-base/modular-components/kvbm/kvbm-design.md)） |
...
- [KV cache offloading](../../../../../pages/developer-guide/knowledge-base/modular-components/kvbm/kvbm-design.md) 通过将 KV 缓存从 HBM 移动到主机内存、本地磁盘或远程存储等成本更低的存储层，扩展可用上下文窗口。复用预计算状态可改善 TTFT、降低总体拥有成本（TCO），并支持更长上下文处理。
...
- [KV Cache Offloading](../../../../../pages/developer-guide/knowledge-base/modular-components/kvbm/kvbm-guide.md) -- 设置多层内存管理
