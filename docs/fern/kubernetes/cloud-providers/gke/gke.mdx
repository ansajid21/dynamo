...
For example, refer to the [`disagg.yaml` manifest](https://github.com/ai-dynamo/dynamo/blob/main/examples/deployments/GKE/vllm/disagg.yaml):
...
```bash
cd examples/deployments/GKE/vllm
