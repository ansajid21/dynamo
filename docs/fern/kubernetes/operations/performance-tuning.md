...
- Use [Sizing with AIConfigurator](../model-deployment/sizing-with-aiconfigurator.mdx) to select tensor parallelism,
...
- If you separate prefill and decode workers, follow [Disaggregated Serving](../model-deployment/disaggregated-serving.md)
...
[AIConfigurator](../model-deployment/sizing-with-aiconfigurator.mdx) with workload parameters that match the
measured traffic.
