...
| Exercise a Kubernetes frontend/router setup without GPUs | [Simulate a Kubernetes Deployment](mocker-live-simulation.mdx) |
...
| Study Planner scaling decisions against a trace | [Benchmark Planner Decisions](dynosim-planner-replay.mdx) |
| Generate a deployable Kubernetes config from model/SLA intent | [Auto Deployment](../../auto-deployment/overview.mdx) |
