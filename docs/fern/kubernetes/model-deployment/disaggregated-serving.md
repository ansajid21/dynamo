...
not authored a DGD before, read the [Deploy with DGD](deploy-with-dgd.md)
...
separately — see [Model caching](kv-cache-offloading.mdx). This
...
for the transport configuration and [Multinode Deployments](multinode-deployments.md)
