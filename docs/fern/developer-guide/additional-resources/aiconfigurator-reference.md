...
you are already authoring, use the shorter [Sizing with AIConfigurator](../../kubernetes/model-deployment/sizing-with-aiconfigurator.mdx)
tutorial. For the serving architecture and deployment-path overview, start with
[Disaggregated Serving](../../kubernetes/model-deployment/disaggregated-serving.md).
...
tuning replica counts. See [Disaggregated Serving](../../kubernetes/model-deployment/disaggregated-serving.md#deploying-disaggregated-with-rdma)
...
4. Add UCX environment variables. See [Disaggregated Serving](../../kubernetes/model-deployment/disaggregated-serving.md#deploying-disaggregated-with-rdma)
