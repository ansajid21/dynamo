...
For a visualization walkthrough, see [Metrics and Dashboards](../../../../../cli/operations/observability.mdx#view-metrics-and-dashboards).
...
[Install Observability](../../../../../cli/installation/observability.mdx).
...
The Planner subscribes to FPM via the NATS event plane. See the [Planner Guide](../../planner/planner-guide.md) for configuration (`load_adjustment_interval`, `max_num_fpm_samples`, `fpm_sample_bucket_size`).
...
For more details on the Tempo/Grafana tracing infrastructure, see the [Local Observability Guide](../../../../../cli/operations/observability.mdx#inspect-traces-and-exported-logs).
...
- [Local Observability Guide](../../../../../cli/operations/observability.mdx#inspect-traces-and-exported-logs) - Distributed tracing with OpenTelemetry and Tempo
- [Metrics and Dashboards](../../../../../cli/operations/observability.mdx#view-metrics-and-dashboards) - Visualization walkthrough
