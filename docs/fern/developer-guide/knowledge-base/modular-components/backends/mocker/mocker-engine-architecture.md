...
For task-oriented instructions, see [Simulate a Kubernetes Deployment](../../../../../kubernetes/operations/dynosim/mocker-live-simulation.mdx) or [Simulate a Local Deployment](../../../../../cli/operations/dynosim/mocker-live-simulation.mdx); for the command-line flags referenced throughout this page, see the [Mocker CLI Reference](../../../../../reference/components/mocker-cli-reference.mdx).
