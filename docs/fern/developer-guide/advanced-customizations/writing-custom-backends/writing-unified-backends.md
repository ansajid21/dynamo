...
| Python workers (lower-level) | You need custom request handling or features not yet covered by the unified backend contract. Use [Python Workers](writing-python-workers.md). |
...
[Model Deployment](../../../kubernetes/model-deployment/overview.mdx).
