...
See [Disaggregated Serving](disaggregated-serving.md) for the DGD topology and
[Disaggregated Communication](../../developer-guide/knowledge-base/kubernetes/kubernetes-operator/disagg-communication.md) for the network requirements. Validate
