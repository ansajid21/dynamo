...
- EFA-enabled container image (e.g., `nvcr.io/nvidia/ai-dynamo/vllm-runtime:1.2.1-efa-amd64`)
...
- [AIConfigurator Deployment Guide](../../../../kubernetes/model-deployment/disaggregated-serving.md)
