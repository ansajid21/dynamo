...
| `--dyn-tool-call-parser` | `DYN_TOOL_CALL_PARSER` | `None` | [Tool call](../../../../../features/tool-calling-and-reasoning/tool-call-parsing.mdx#supported-tool-call-parsers) parser (overrides SGLang's `--tool-call-parser`) |
| `--dyn-reasoning-parser` | `DYN_REASONING_PARSER` | `None` | [Reasoning](../../../../../features/tool-calling-and-reasoning/reasoning-parsing.md#supported-reasoning-parsers) parser for chain-of-thought models |
...
| `--image-diffusion-worker` | `DYN_SGL_IMAGE_DIFFUSION_WORKER` | `false` | Run as [image diffusion](../../../../../features/diffusion/workflows/text-to-image.md#sglang) worker |
| `--video-generation-worker` | `DYN_SGL_VIDEO_GENERATION_WORKER` | `false` | Run as [video generation](../../../../../features/diffusion/workflows/text-to-video.md#sglang) worker |
...
The current supported parser names for both flags are documented in [Tool Call Parsing (Dynamo)](../../../../../features/tool-calling-and-reasoning/tool-call-parsing.mdx#supported-tool-call-parsers) and [Reasoning Parsing (Dynamo)](../../../../../features/tool-calling-and-reasoning/reasoning-parsing.md#supported-reasoning-parsers).
...
- **[Diffusion](../../../../../features/diffusion/overview.md)**: LLM, image, and video diffusion models
