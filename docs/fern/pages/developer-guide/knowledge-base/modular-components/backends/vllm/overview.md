...
| [**LMCache**](../../../../../cli/model-deployment/kv-cache-offloading.mdx) | ✅ | CUDA 12.9 and arm64/aarch64 containers may require building LMCache from source |
| [**FlexKV**](../../../../../cli/model-deployment/kv-cache-offloading.mdx) | ✅ | Requires a separate FlexKV build |
| [**Multimodal Support**](../../../../../features/diffusion/overview.md) | ✅ | Via vLLM-Omni integration |
...
> **Notes:**
> 1. **Multimodal + KV-Aware Routing**: Image-aware KV routing is supported in the documented vLLM paths. The default Rust frontend path supports model families handled by `llm-multimodal`; the Python chat-processor path delegates to vLLM's multimodal processor. ([Source](../../../../../features/multimodal-serving/multimodal-kv-routing.md))
...
- **[Observability](observability.md)**: Metrics and monitoring
- **[vLLM-Omni](../../../../../features/diffusion/overview.md)**: Multimodal model serving
