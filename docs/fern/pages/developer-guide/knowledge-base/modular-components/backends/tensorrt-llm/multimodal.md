...
TRT-LLM supports aggregated and traditional disaggregated patterns. See [Multimodal Model Serving](../../../../../features/multimodal-serving/overview.md) for detailed explanations.
...
For the user-facing workflow, see [Multimodal KV Routing](../../../../../features/multimodal-serving/multimodal-kv-routing.md).
