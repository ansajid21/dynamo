...
- Dynamo platform installed (see [Installation Guide](../../../../kubernetes/installation/install-dynamo.md))
...
| [Profiler Configuration Reference](../../../../reference/components/profiler-configuration.mdx) | CLI arguments for the SLA and per-endpoint profilers |
