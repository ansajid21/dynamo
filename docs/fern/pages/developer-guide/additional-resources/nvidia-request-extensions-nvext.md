...
session headers described in [Session IDs](../../features/agents/session-ids.mdx);
...
[Agent Tracing](../../features/agents/agent-tracing.md).
...
[Priority Scheduling](../../features/agents/priority-scheduling.md).
...
| [Session IDs](../../features/agents/session-ids.mdx) | Passive session identity |
| [Agent Tracing](../../features/agents/agent-tracing.md) | JSONL request traces, inferred tool-call metadata, and harness tool-event ingestion |
| [Agent Hints](../../features/agents/agent-hints.md) | Per-request serving hints for routing, scheduling, and cache behavior |
