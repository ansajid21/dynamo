...
For the profiling workflow and DGDR spec structure, see the [Profiler Guide](../../developer-guide/knowledge-base/modular-components/profiler/overview.md). Field names, types, and defaults on this page come from [`__main__.py`](https://github.com/ai-dynamo/dynamo/blob/main/components/src/dynamo/profiler/__main__.py) and [`profile_endpoint.py`](https://github.com/ai-dynamo/dynamo/blob/main/components/src/dynamo/profiler/profile_endpoint.py).
...
<CardGroup cols={2}>
  <Card title="Profiler Guide" href="../../developer-guide/knowledge-base/modular-components/profiler/overview.md" icon="book">
    Profiling workflow, DGDR spec structure, and how the SLA recommendation is produced.
  </Card>
  <Card title="Profiler Examples" href="../../developer-guide/knowledge-base/modular-components/profiler/profiler-examples.md" icon="terminal">
    End-to-end profiling runs and how to read the output.
  </Card>
  <Card title="Planner Configuration" href="planner-configuration.mdx" icon="sliders">
