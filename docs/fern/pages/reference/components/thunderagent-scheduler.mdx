...
Programs are keyed by the normalized `session_id`. Use the canonical headers defined in [Session IDs](../../features/agents/session-ids.mdx):
...
- [ThunderAgent Scheduler Design](../../features/agents/thunderagent-program-scheduler.md)
