...
<BlogArticleMeta
  authors={[
    ...
    { name: "Dan Feigin", href: "https://developer.nvidia.com/blog/author/danfeigin/" },
...
![Kubernetes checkpoint and restore lifecycle with NVIDIA Dynamo Snapshot.](../_assets/snapshot/dynamo-snapshot-lifecycle.webp)
