...
<BlogArticleMeta
  authors={[
    { name: "Rudy Pei" },
    { name: "John Thomson", href: "https://developer.nvidia.com/blog/author/jwillthomson/" },
    { name: "Janelle Cai" },
    { name: "Alec Flowers" },
    { name: "Ryan Olson" },
    { name: "Dan Gil" },
...
<Frame caption="Figure 1 — KV Event Density">
  <img src="../_assets/flash-indexer/images/fig-1-kv-event-density.svg" alt="KV Event Density" />
</Frame>
...
<Frame caption="Figure 2 — KV Event Flow">
  <img src="../_assets/flash-indexer/images/fig-2-kv-event-flow.svg" alt="KV Event Flow" style={{width: "100%"}} />
</Frame>
...
<Frame caption="Figure 3 — Prefix Tree Structure">
  <img src="../_assets/flash-indexer/images/fig-3-prefix-tree.svg" alt="Prefix Tree Structure" style={{maxWidth: "420px", width: "100%"}} />
</Frame>
...
<Frame caption="Figure 4 — Concurrency Model">
  <img src="../_assets/flash-indexer/images/fig-4-concurrency-model.svg" alt="Concurrency Model" style={{width: "100%"}} />
</Frame>
...
<Frame caption="Figure 5 — Positional Jump Search">
  <img src="../_assets/flash-indexer/images/fig-5-jump-search.svg" alt="Positional Jump Search" style={{width: "100%"}} />
</Frame>
...
<Frame caption="Figure 6 — Indexer Performance">
  <img src="../_assets/flash-indexer/images/fig-6-indexer-throughput.svg" alt="Indexer Performance" />
</Frame>
