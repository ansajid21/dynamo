...
Use [Simulate a Local Deployment with Mocker](../../cli/operations/dynosim/mocker-live-simulation.mdx) instead when you need to exercise the
...
[Kubernetes deployment](../../kubernetes/operations/benchmarking-with-aiperf.mdx) or a [local CLI deployment](../../cli/operations/benchmarking-with-aiperf.mdx) to include
