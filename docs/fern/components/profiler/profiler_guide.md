...
- [DGDR Examples](../../developer-guide/knowledge-base/modular-components/profiler/profiler-examples.md) - Complete DGDR YAML examples
- [DGDR API Reference](../../reference/kubernetes-api/additional-resources/api-reference-k8s.md) - DGDR specification
