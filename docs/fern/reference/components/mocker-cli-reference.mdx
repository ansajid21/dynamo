...
The same engine settings apply to [DynoSim Runs](../../shared/dynosim/dynosim-replay.mdx): `python -m dynamo.replay`
...
<CardGroup cols={2}>
  ...
  <Card title="Run a DynoSim Simulation" icon="play" href="../../shared/dynosim/dynosim-replay.mdx">
