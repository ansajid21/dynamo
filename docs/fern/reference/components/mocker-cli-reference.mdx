...
[Simulate a Kubernetes Deployment](../../kubernetes/operations/dynosim/mocker-live-simulation.mdx) or
[Simulate a Local Deployment](../../cli/operations/dynosim/mocker-live-simulation.mdx); for the engine internals these flags
...
The same engine settings apply to [DynoSim Runs](../../cli/operations/dynosim/dynosim-replay.mdx): `python -m dynamo.replay`
...
<CardGroup cols={2}>
  <Card title="Simulate a Kubernetes Deployment" icon="server" href="../../kubernetes/operations/dynosim/mocker-live-simulation.mdx">
    Deploy and run the Mocker worker on Kubernetes.
  </Card>
  <Card title="Simulate a Local Deployment" icon="terminal" href="../../cli/operations/dynosim/mocker-live-simulation.mdx">
    Run a frontend and Mocker worker from the command line.
  </Card>
  <Card title="Run a DynoSim Simulation" icon="play" href="../../cli/operations/dynosim/dynosim-replay.mdx">
