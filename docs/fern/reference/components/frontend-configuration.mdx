...
<ParamField path="--router-policy-config" type="string" default="null">
  ...
  threshold is configured. See [Policy-class queues](../../developer-guide/knowledge-base/modular-components/router/configuration-and-tuning.md#policy-class-queues).
...
<ParamField path="--dyn-chat-processor" type="string" default="dynamo">
  Chat processor. See [Chat Processors](../../features/tool-calling-and-reasoning/chat-processors.mdx) for how this combines with the parser flags.
