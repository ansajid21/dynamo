...
First, deploy your DynamoGraphDeployment using the [deployment documentation](../docs/fern/kubernetes/getting-started/quickstart.mdx), then:
...
For detailed documentation including server-side benchmarking, Pareto analysis, and advanced AIPerf features, see the [complete benchmarking guide](../docs/fern/recipes/feature-benchmarks/benchmarking-guide.md).
