...
For detailed explanations of router arguments (especially KV cache routing parameters), see the [Router Guide](../../docs/fern/developer-guide/knowledge-base/modular-components/router/router-guide.md).
...
No additional configuration is needed - simply launch both decode and prefill workers, and the system handles the rest. See the [Router Guide](../../docs/fern/developer-guide/knowledge-base/modular-components/router/router-guide.md#disaggregated-serving) for more details.
