...
- Dynamo Kubernetes Platform installed (see [Kubernetes Quickstart](../../docs/fern/kubernetes/getting-started/quickstart.mdx))
...
- [Global Planner Deployment Guide](../../docs/fern/developer-guide/knowledge-base/modular-components/planner/global-planner-guide.md)
- [Global Planner README](../../components/src/dynamo/global_planner/README.md)
- [Planner Configuration Guide](../../docs/fern/developer-guide/knowledge-base/modular-components/planner/planner-guide.md)
