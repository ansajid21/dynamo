...
See the [DGDR walkthrough](https://github.com/ai-dynamo/dynamo/blob/main/docs/fern/pages/kubernetes/auto-deployment/auto-deploy-with-dgdr.md)
and [DGDR reference](https://github.com/ai-dynamo/dynamo/blob/main/docs/fern/pages/reference/kubernetes-api/dynamo-graph-deployment-request.mdx)
