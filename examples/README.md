...
- **[Disaggregated Serving](../docs/fern/kubernetes/model-deployment/disaggregated-serving.md)** - Prefill/decode separation for enhanced performance and scalability
- **[Multi-node TensorRT-LLM](../docs/fern/developer-guide/additional-resources/tensorrt-llm-details/multinode-examples.md)** - Distributed inference across multiple nodes and GPUs
...
- **[Amazon EKS](deployments/EKS/README.md)** - Manifests and templates ([deployment guide](../docs/fern/kubernetes/installation/managed-kubernetes/eks/eks-setup.mdx))
- **[Azure AKS](deployments/AKS/README.md)** - Helm values ([deployment guide](../docs/fern/kubernetes/installation/managed-kubernetes/azure/aks-setup.mdx))
- **[Amazon ECS](deployments/ECS/README.md)** - Task definitions ([deployment guide](../docs/fern/kubernetes/installation/managed-kubernetes/eks/ecs.mdx))
- **[Google GKE](deployments/GKE/README.md)** - DGD manifests ([deployment guide](../docs/fern/kubernetes/installation/managed-kubernetes/gcp/gke-setup.mdx))
...
1. **Choose your deployment pattern**: Start with the [Quickstart](https://docs.nvidia.com/dynamo/getting-started/quickstart) for a simple local deployment, or explore [Disaggregated Serving](../docs/fern/kubernetes/model-deployment/disaggregated-serving.md) for advanced architectures.
...
See the [Kubernetes Installation Guide](../docs/fern/kubernetes/installation/install-dynamo.md#prerequisites) for detailed setup instructions and pre-deployment checks.
