...
- **[Disaggregated Serving](../docs/fern/pages/kubernetes/model-deployment/disaggregated-serving.md)** - Prefill/decode separation for enhanced performance and scalability
...
1. **Choose your deployment pattern**: Start with the [Quickstart](https://docs.nvidia.com/dynamo/getting-started/quickstart) for a simple local deployment, or explore [Disaggregated Serving](../docs/fern/pages/kubernetes/model-deployment/disaggregated-serving.md) for advanced architectures.
