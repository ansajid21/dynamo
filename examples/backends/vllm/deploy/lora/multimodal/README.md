...
The top-level DynamoGraphDeployment (DGD) manifest uses `nvidia.com/v1beta1`; the deprecated DGD is
under `v1alpha1/`. `DynamoModel` does not have a `v1beta1` API and continues to use
`nvidia.com/v1alpha1`.
