...
The top-level `deploy/*.yaml` templates use the supported `nvidia.com/v1beta1` API. Deprecated
`nvidia.com/v1alpha1` templates remain available under [`v1alpha1/`](./v1alpha1/) for migration and
