...
1. **Dynamo Kubernetes Platform installed** - See [Installing Dynamo Kubernetes Platform](../../../../docs/fern/kubernetes/installation/install-dynamo.md)
...
- **Kubernetes Templates**: [SGLang Deployment Templates](../../../../docs/fern/recipes/kubernetes-templates/dgd/sglang.mdx)
...
For additional support, refer to the [deployment guide](../../../../docs/fern/kubernetes/getting-started/quickstart.mdx).
