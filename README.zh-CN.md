...
| [**工具调用**](docs/fern/pages/features/tool-calling-and-reasoning/tool-call-parsing.mdx) | ✅ | ✅ | ✅ |
...
- **[贡献指南](docs/fern/pages/developer-guide/contributing/overview.md)** — 如何贡献代码、文档和配方
