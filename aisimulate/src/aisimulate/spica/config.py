...
``docs/fern/developer-guide/knowledge-base/modular-components/ai-simulate-experimental/spica-experimental/search-flow.md`` for the experimental design:
...
# docs/fern/developer-guide/knowledge-base/modular-components/ai-simulate-experimental/spica-experimental/search-space.md.
                ...
                if isinstance(v, dict):
                    ...
                    if missing:
                        raise ValueError(
                            ...
                            "(see docs/fern/developer-guide/knowledge-base/modular-components/ai-simulate-experimental/spica-experimental/search-space.md)"
                        )
