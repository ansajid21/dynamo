...
"""Contract helpers for the Backend SDK multimodal wire shape.

Three small helpers, parallel to the prefill/decode pair in
``dynamo.backend.disagg``:
...
from ._engine import GenerateChunk, GenerateRequest
...
def require_encoder_result(
    ...
    Analog of :func:`dynamo.backend.disagg.require_prefill_result`.
