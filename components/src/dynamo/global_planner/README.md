...
- [Planner Guide](../../../../docs/fern/developer-guide/knowledge-base/modular-components/planner/planner-guide.md) — Planner configuration and deployment workflow
- [Global Planner Deployment Guide](../../../../docs/fern/developer-guide/knowledge-base/modular-components/planner/global-planner-guide.md) — Deployment patterns for `GlobalPlanner`, including multi-model coordination and single-endpoint multi-pool workflows
- [Planner Design](../../../../docs/fern/developer-guide/knowledge-base/modular-components/planner/planner-design.md) — Planner architecture and algorithms
