...
documented in [docs/agents/thunderagent-router.md](../../../../docs/fern/features/agents/thunderagent-program-scheduler.md#utilization-driven-control-loop).
...
See [Agent Tracing](../../../../docs/fern/features/agents/agent-tracing.md) for the record schema.
...
- Conceptual docs: [docs/agents/thunderagent-router.md](../../../../docs/fern/features/agents/thunderagent-program-scheduler.md)
...
- Dynamo KV router: [Router Guide](../../../../docs/fern/developer-guide/knowledge-base/modular-components/router/router-guide.md)
