...
documented in [docs/agents/thunderagent-router.md](../../../../docs/fern/pages/features/agents/thunderagent-program-scheduler.md#utilization-driven-control-loop).
...
See [Agent Tracing](../../../../docs/fern/pages/features/agents/agent-tracing.md) for the record schema.
...
- Conceptual docs: [docs/agents/thunderagent-router.md](../../../../docs/fern/pages/features/agents/thunderagent-program-scheduler.md)
