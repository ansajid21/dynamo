...
- **User docs**: [Planner Guide](../../../../docs/fern/developer-guide/knowledge-base/modular-components/planner/planner-guide.md) (deployment, configuration, examples)
- **Design docs**: [Planner Design](../../../../docs/fern/developer-guide/knowledge-base/modular-components/planner/planner-design.md) (architecture, algorithms)
