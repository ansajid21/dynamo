...
👉 **[Follow the Dynamo Kubernetes Platform installation guide](../../docs/fern/kubernetes/installation/install-dynamo.md) to install the Dynamo Kubernetes Platform first.**
...
- **Benchmarking Guide**: See [docs/benchmarks/benchmarking.md](../../docs/fern/recipes/feature-benchmarks/benchmarking-guide.md) for comparing DynamoGraphDeployments and external endpoints
- **Pre-Deployment Profiling**: See [docs/components/profiler/profiler-guide.md](../../docs/fern/developer-guide/knowledge-base/modular-components/profiler/profiler-guide.md) for optimizing configurations before deployment
