...
// ValidateCheckpointFailoverCompatibility rejects enabled checkpoint/snapshot
// combined with active/passive failover.
func ValidateCheckpointFailoverCompatibility(experimental *v1beta1.ExperimentalSpec) error {
